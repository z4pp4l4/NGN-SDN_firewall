...
class ToplevelWindow(customtkinter.CTkToplevel):
    def __init__(self, master, value):
        ...
        if value_cat=="host":
            ...
            self.label_mac_internal=customtkinter.CTkLabel(self, text="mac address for internal network: 00:00:00:00:00:1B")
            self.label_mac_internal.grid(row=0, column=0, padx=10, pady=10)
            self.label_mac_external=customtkinter.CTkLabel(self, text= "mac address for external network: 00:00:00:00:00:1C")
